...
public class LevelProgress : MonoBehaviour
{
    ...
    private string saveCoinKey;
    private int coins = 0;
    void Start()
    {
        saveProgressKey = "Level" + SceneManager.GetActiveScene().buildIndex + "Progress";
        saveCoinKey = "Level" + SceneManager.GetActiveScene().buildIndex + "Coins";
    ...
    public void SaveProgressWithCoins()
    {
        ...
        if (coins > PlayerPrefs.GetFloat(saveCoinKey, 0))
        {
            PlayerPrefs.SetInt(saveCoinKey, coins);
            PlayerPrefs.Save();
        }
